...
export const CATALOGS = {
  credenciales: { title: 'Credenciales de equipos', description: 'Cuentas y licencias asociadas. Las contraseñas de los activos no se copian.', columns: [['center_code', 'Código TI'], ['usuario_asignado', 'Usuario'], ['win_usuario', 'Windows'], ['ms_usuario', 'Microsoft'], ['ms_licencia', 'Licencia'], ['ms_vencimiento', 'Vencimiento Microsoft 365'], ['correo_mrt', 'Correo MRT'], ['av_caducidad', 'Adquisición antivirus'], ['av_vencimiento', 'Vencimiento antivirus']] },
...
const CATALOG_CREATE_FORMS = {
  credenciales: { endpoint: '/activos', singular: 'credencial de equipo', note: 'El código TI crea un activo nuevo; después podrás completar su ficha y asignación.', fields: [['center_code', 'Código TI', 'text', true], ['tipo', 'Tipo', 'select', false, ['Laptop', 'PC', 'Servidor']], ['descripcion', 'Descripción'], ['win_cuenta', 'Cuenta Windows'], ['win_usuario', 'Usuario Windows'], ['ms_cuenta', 'Cuenta Microsoft 365'], ['ms_usuario', 'Usuario Microsoft 365'], ['ms_licencia', 'Licencia Microsoft 365'], ['ms_vencimiento', 'Vencimiento Microsoft 365', 'date'], ['db_cuenta', 'Cuenta Dropbox'], ['db_usuario', 'Usuario Dropbox'], ['db_licencia', 'Licencia Dropbox'], ['correo_mrt', 'Correo MRT', 'email'], ['correo_corporativo', 'Correo corporativo', 'email'], ['av_licencia', 'Licencia antivirus'], ['av_caducidad', 'Adquisición antivirus', 'date'], ['av_vencimiento', 'Vencimiento antivirus', 'date']] },
