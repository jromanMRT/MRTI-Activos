...
export function AssetCatalogPage() {
  ...
  return <div>
    <div className="mb-5"><Link to="/" className="text-sm text-sky-400 hover:underline">← Dashboard de activos</Link><h1 className="mt-2 text-2xl font-bold">{config.title}</h1>{config.description && <p className="mt-1 text-sm text-slate-400">{config.description}</p>}</div>
