...
import { apiPreview, apiDownload, apiFetch } from '../api.js';
...
const CATALOG_CREATE_FORMS = {
  ...
  fortigate: { singular: 'licencia FortiGate', fields: [['software', 'Software'], ['numero_serie', 'Número de serie', 'text', true], ['proyecto', 'Proyecto'], ['fecha_expira', 'Fecha de vencimiento', 'date'], ['comentario', 'Comentario', 'textarea']] },
