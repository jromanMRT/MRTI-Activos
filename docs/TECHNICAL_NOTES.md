...
repuesto o número de parte, enlace web opcional y vínculo opcional por `asset_uid`.
No requiere archivos. Las notas generales pueden describir compatibilidad con
varios modelos sin vincularse a un equipo específico.
